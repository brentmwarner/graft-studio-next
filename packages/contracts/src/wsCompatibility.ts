...
export const WS_COMPATIBILITY_QUERY = {
  clientBuild: "x-graft-client-build",
  protocolEpoch: "x-graft-protocol-epoch",
  protocolRevision: "x-graft-protocol-revision",
  serverInstanceId: "x-graft-server-instance",
} as const;

export const WS_NEGOTIATE_QUERY = {
  clientBuild: "x-graft-client-build",
  protocolEpoch: "x-graft-protocol-epoch",
  minRevision: "x-graft-protocol-min-revision",
  maxRevision: "x-graft-protocol-max-revision",
  requiredCapability: "x-graft-required-capability",
} as const;
