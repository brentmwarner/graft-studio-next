...
// Unified cross-provider skills catalog (Graft portable skills). Descriptors use
// `scope` to carry the origin label ("graft", "codex", "claude", "cursor", ...).
...
export const ProviderSkillsCatalogResult = Schema.Struct({
  skills: Schema.Array(ProviderSkillDescriptor),
  graftSkillsDir: Schema.optional(TrimmedNonEmptyString),
});
