...
import {
  GraftCapabilitiesResult,
  GraftCreateThreadsInput,
  GraftCreateThreadsResult,
  GraftGatewayErrorResult,
  GraftWaitForThreadsInput,
  GraftWaitForThreadsResult,
} from "./agentGateway";

const decodeCreate = Schema.decodeUnknownSync(GraftCreateThreadsInput);
const decodeWait = Schema.decodeUnknownSync(GraftWaitForThreadsInput);
...
describe("agent gateway contracts", () => {
  ...
  it("decodes typed capability, creation, wait, and error results", () => {
    assert.doesNotThrow(() =>
      Schema.decodeUnknownSync(GraftCapabilitiesResult)({
        targetConstruction: {
          codex: {
    ...
    assert.doesNotThrow(() =>
      Schema.decodeUnknownSync(GraftCreateThreadsResult)({
    ...
    assert.doesNotThrow(() =>
      Schema.decodeUnknownSync(GraftWaitForThreadsResult)({
    ...
    assert.doesNotThrow(() =>
      Schema.decodeUnknownSync(GraftGatewayErrorResult)({
