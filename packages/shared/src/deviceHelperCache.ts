 ...
 *
 * This lives in `@graft/shared` because two independent callers derive the
...
/** `~/Library/Caches/graft/device-helper` — callers pass their own home dir. */
...
export const DEVICE_HELPER_BINARY_NAME = "graft-device-helper";

/** Physical helper source directory passed from packaged desktop to its backend child. */
export const DEVICE_HELPER_SOURCE_DIR_ENV = "GRAFT_DEVICE_HELPER_SOURCE_DIR";
