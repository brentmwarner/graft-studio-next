...
export const MIGRATION_DIVERGENCE_CONSENT_ENV = "GRAFT_MIGRATION_DIVERGENCE_CONSENT";
export const MIGRATION_RUNTIME_SOURCE_DIGEST_ENV = "GRAFT_MIGRATION_RUNTIME_SOURCE_DIGEST";
...
export const MIGRATION_DIVERGENCE_CONSENT_REQUIRED_PREFIX =
  "GRAFT_MIGRATION_DIVERGENCE_CONSENT_REQUIRED=";
export const MIGRATION_SCHEMA_TOO_NEW_BLOCK_PREFIX = "GRAFT_MIGRATION_SCHEMA_TOO_NEW=";
