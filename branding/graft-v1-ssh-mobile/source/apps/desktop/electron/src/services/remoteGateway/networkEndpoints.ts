...
import { toWebSocketBaseUrl, type GraftRemoteEndpointKind } from "@graft/shared";
import type { RemoteGatewayEndpoint } from "./types.js";

/** Kinds discoverable from this host's own network interfaces. */
export type LocalNetworkEndpointKind = "loopback" | "lan" | "tailnet";

export type DiscoveredNetworkEndpoint = RemoteGatewayEndpoint & {
