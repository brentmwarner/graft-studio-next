  ...
  return (
    <View style={styles.iosMenu}>
      <View style={styles.iosHeader}>
        ...
        <CircleIconButton accessibilityLabel="Search chats" icon="search" onPress={onSearch} />
      </View>
                ...
                {({ pressed }) => (
                  <View style={[styles.recentRow, { opacity: pressed ? 0.55 : 1 }]}>
                    ...
                    {thread.showsAttentionDot ? (
                      <View style={[styles.connectionDot, { backgroundColor: palette.info }]} />
                    ) : null}
                  </View>
                )}
              </Pressable>
...
const styles = StyleSheet.create({
  ...
  iosBrand: { flex: 1, paddingBottom: 0, paddingHorizontal: 0 },
  iosMenu: { flex: 1 },
  iosHeader: {
    alignItems: "center",
    flexDirection: "row",
  ...
  chatPillLabel: { color: "#FFFFFF", fontSize: 16, fontWeight: "600" },
  row: {
    alignItems: "center",
    flexDirection: "row",
    minHeight: 49,
