#!/bin/bash
# Compiles graft-device-helper with the user's own Xcode toolchain.
#
...
#   GRAFT_DEVICE_HELPER_OUT=/path build.sh
#
...
OUT_DIR="${1:-${GRAFT_DEVICE_HELPER_OUT:-$SOURCE_DIR/build}}"
BINARY_NAME="graft-device-helper"
