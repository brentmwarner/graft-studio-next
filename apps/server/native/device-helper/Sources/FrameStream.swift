...
final class FrameSocketWriter {
  ...
  private let queue = DispatchQueue(label: "dev.graft.device-helper.socket")
...
final class FrameStream {
  ...
  private let encodeQueue = DispatchQueue(label: "dev.graft.device-helper.encode")
