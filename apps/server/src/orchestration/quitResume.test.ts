...
import { ProjectId, ThreadId, TurnId, type OrchestrationCommand } from "@graft/contracts";
...
const PROMPT = "Graft was closed while this chat was still running. Continue where you left off.";
