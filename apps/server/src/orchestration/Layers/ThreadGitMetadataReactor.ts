import { CommandId, type ProviderRuntimeEvent, type ThreadId } from "@graft/contracts";
...
const make = Effect.gen(function* () {
  ...
  const processProviderEvent = (event: ProviderRuntimeEvent) => {
    // Native subagent lifecycle events carry the parent Graft thread id and the child identity
