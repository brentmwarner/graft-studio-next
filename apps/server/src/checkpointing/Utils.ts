...
import { resolveThreadWorkspaceCwd as resolveSharedThreadWorkspaceCwd } from "@graft/shared/threadEnvironment";

export const CHECKPOINT_REFS_PREFIX = "refs/graft/checkpoints";
