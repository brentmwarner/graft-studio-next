...
import { tracePackagedLayerCompletion } from "./packagedStartupTrace";
...
export function makeServerRuntimeServicesLayer(
  ...
  return Layer.mergeAll(
    tracePackagedLayerCompletion("agentGatewayCredentials", agentGatewayCredentialsLayer),
    tracePackagedLayerCompletion("agentGateway", agentGatewayLayer),
    tracePackagedLayerCompletion("browserAutomationHost", BrowserAutomationHostLive),
    tracePackagedLayerCompletion("automationService", automationServiceLayer),
    tracePackagedLayerCompletion("automationScheduler", automationSchedulerLayer),
    tracePackagedLayerCompletion("automationRunReactor", automationRunReactorLayer),
    tracePackagedLayerCompletion("managedAttachmentCleanup", managedAttachmentCleanupLayer),
    tracePackagedLayerCompletion("automationRepository", AutomationRepositoryLive),
    tracePackagedLayerCompletion(
      "agentGatewayOperationRepository",
      AgentGatewayOperationRepositoryLive,
    ),
    tracePackagedLayerCompletion("externalMcpRepository", ExternalMcpRepositoryLive),
    tracePackagedLayerCompletion("externalMcpService", externalMcpServiceLayer),
    tracePackagedLayerCompletion("externalMcpGateway", externalMcpGatewayLayer),
    tracePackagedLayerCompletion("providerHealth", providerHealthLayer),
    tracePackagedLayerCompletion("projectPullRequestPins", ProjectPullRequestPinsLive),
    tracePackagedLayerCompletion("pullRequestService", pullRequestServiceLayer),
    tracePackagedLayerCompletion("orchestrationReactor", orchestrationReactorLayer),
    tracePackagedLayerCompletion("providerCommandReactor", providerCommandReactorLayer),
    tracePackagedLayerCompletion("sidechatExpiryReactor", sidechatExpiryReactorLayer),
    tracePackagedLayerCompletion("threadGitMetadataReactor", threadGitMetadataReactorLayer),
    tracePackagedLayerCompletion("threadDeletionReactor", threadDeletionReactorLayer),
    tracePackagedLayerCompletion("devServerManager", devServerManagerLayer),
    tracePackagedLayerCompletion("deviceService", DeviceServiceLive),
    tracePackagedLayerCompletion("git", GitLayerLive),
    tracePackagedLayerCompletion("textGeneration", TextGenerationLayerLive),
    tracePackagedLayerCompletion("terminal", TerminalLayerLive),
    tracePackagedLayerCompletion("keybindings", KeybindingsLive),
    tracePackagedLayerCompletion("serverSettings", ServerSettingsLive),
    tracePackagedLayerCompletion("serverEnvironment", ServerEnvironmentLive),
    tracePackagedLayerCompletion("profileStatsQuery", ProfileStatsQueryLive),
    tracePackagedLayerCompletion("authServices", authServicesLayer),
    tracePackagedLayerCompletion("serverLifecycleEvents", ServerLifecycleEventsLive),
    tracePackagedLayerCompletion("serverRuntimeStartup", ServerRuntimeStartupLive),
    tracePackagedLayerCompletion("workspace", WorkspaceLayerLive),
    tracePackagedLayerCompletion("projectFaviconResolver", ProjectFaviconResolverLive),
