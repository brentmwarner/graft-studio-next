/**
 * AgentGateway - Graft app-control tool surface for provider agents.
 *
 * Serves the `graft_*` MCP tools that let any provider session (Codex,
 * Claude, Grok, ...) inspect and control Graft itself: list projects and
...
export class AgentGateway extends ServiceMap.Service<AgentGateway, AgentGatewayShape>()(
  "graft/agentGateway/Services/AgentGateway",
) {}
