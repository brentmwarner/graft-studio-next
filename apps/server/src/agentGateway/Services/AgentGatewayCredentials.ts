/**
 * AgentGatewayCredentials - Per-session credentials for the Graft agent
 * gateway.
 *
...
export interface AgentGatewayCredentialsShape {
  /** Streamable-HTTP MCP endpoint served by this Graft instance. */
...
>()("graft/agentGateway/Services/AgentGatewayCredentials") {}
