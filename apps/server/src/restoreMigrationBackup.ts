...
const USAGE =
  "Usage: graft-restore-migration-backup <absolute-database-path> " +
  "[--backup-path <absolute-backup-path> --provenance-path <absolute-provenance-path>]";
const STOP_PROCESSES_WARNING =
  "WARNING: Stop every Graft process before restoring a migration backup.";
...
const entryPointNames = new Set([
  ...
  "graft-restore-migration-backup",
]);
