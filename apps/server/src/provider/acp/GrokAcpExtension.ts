import type { ProviderUserInputAnswers, UserInputQuestion } from "@graft/contracts";
...
const GRAFT_PLAN_REVIEW_FEEDBACK =
...
/**
 * Graft owns the approval step after the planning turn settles. Returning a
...
export function makeGrokExitPlanModeCapturedResponse(): {
  ...
  return {
    outcome: "cancelled",
    feedback: GRAFT_PLAN_REVIEW_FEEDBACK,
  };
}

/** Graft has already received an implementation turn, so Grok may leave its native gate. */
