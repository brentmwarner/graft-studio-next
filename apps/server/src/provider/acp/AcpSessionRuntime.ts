...
import { resolveExecutionWorkingDirectory } from "@graft/shared/wslBridge";
import {
  Cause,
  Deferred,
  Effect,
...
export interface AcpSessionRuntimeOptions {
   ...
   * `mcpCapabilities` (e.g. HTTP vs stdio for the Graft agent gateway).
   */
...
/**
 * Bridges Effect's child-process exit signal into Graft's process-tree proof. This is deliberately
...
>()("graft/provider/acp/AcpSessionRuntime") {
  static layer(
