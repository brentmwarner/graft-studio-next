...
// Purpose: Bridges ACP form elicitation schemas to Graft's provider-neutral question UI.
...
// Converts primitive ACP form fields into the question shape consumed by Graft's composer.
