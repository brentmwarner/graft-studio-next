...
import type { ChatAttachment, ProviderKind, ThreadId } from "@graft/contracts";
...
const PROVIDER_ATTACHMENT_STORAGE_PATH = Symbol("graft.providerAttachmentStoragePath");
