...
import { IsoDateTime, NonNegativeInt, SpaceIconName, SpaceId, SpaceName } from "@graft/contracts";
...
>()("graft/persistence/Services/ProjectionSpaces/ProjectionSpaceRepository") {}
