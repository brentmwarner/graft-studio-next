import { EventId, IsoDateTime, NonNegativeInt, ThreadId } from "@graft/contracts";
...
>()(
  "graft/persistence/Services/OrchestrationEventDeliveries/OrchestrationEventDeliveryRepository",
) {}
