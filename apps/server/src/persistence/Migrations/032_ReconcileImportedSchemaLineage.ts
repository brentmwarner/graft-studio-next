 ...
 * names. Because the migrator skips by ID, Graft migrations 17-31 never run
 ...
 * Graft migrations known at the time, but predecessor trackers eventually
 ...
 *
 * Idempotent and a no-op for fresh Graft installs (every column already
