...
const logPath = process.env.GRAFT_ACP_CONFORMANCE_LOG_PATH;
const malformedPrefix = process.env.GRAFT_ACP_CONFORMANCE_MALFORMED_PREFIX === "1";
...
const app = agent({ name: "graft-official-sdk-conformance-agent" })
