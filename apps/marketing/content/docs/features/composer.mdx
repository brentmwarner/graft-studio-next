...
- **Checkpoints** let you revert a thread to an earlier state — Graft refuses the revert while a turn is still running, so you can't pull the rug out from under an active agent.
