...
description: Complete and verify a coding task in Graft from a known repository state to a reviewed change.
---
...
Add the local repository to Graft.
...
- Use a provider you have already verified outside Graft
