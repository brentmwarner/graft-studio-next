...
const HELP_PAGES = [
  ...
  },
  {
    ...
    requiredSections: [
      ...
      "Provider works directly but fails in Graft",
  ...
  },
  {
    ...
    requiredSections: [
      ...
      "Integration targets the wrong Graft instance",
