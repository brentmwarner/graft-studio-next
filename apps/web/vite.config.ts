// FILE: vite.config.ts
// Purpose: Builds the Graft web client and controls diagnostic source maps.
...
const sourcemapEnv = process.env.GRAFT_WEB_SOURCEMAP?.trim().toLowerCase();
