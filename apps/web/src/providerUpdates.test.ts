...
import type { ProviderKind, ServerProviderStatus, ServerSettings } from "@graft/contracts";
...
describe("getVisibleProviderUpdateStatuses", () => {
  it("excludes providers hidden from Graft so unchecked providers do not nag", () => {
...
describe("shouldPromptProviderUpdate", () => {
  // Cursor and Antigravity self-update, so Graft has no registry to read a latest
  ...
  it("keeps prompting for providers Graft can prove are behind", () => {
