...
// A provider whose latest version Graft cannot look up (self-updating CLIs such as
...
// Header affordance: reserved for providers Graft can actually assert are outdated.
