...
import { isTemporaryWorktreeBranch, resolveUniqueGraftBranchName } from "@graft/shared/git";
...
export function resolveDefaultCreateBranchName(
  ...
  return resolveUniqueGraftBranchName(existingBranchNames, preferredBranch);
}
...
export { resolveAutoFeatureBranchName } from "@graft/shared/git";
