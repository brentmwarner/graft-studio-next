...
export const SETTINGS_NAV_ITEMS: readonly SettingsNavItem[] = [
  ...
  },
  {
    ...
    group: "personal",
    label: "Notifications",
    description: "Choose how Graft tells you when work finishes or needs attention.",
    icon: "bell",
    eyebrow: "Alerts",
  },
  {
  ...
  },
  {
    ...
    group: "personal",
    label: "Keybindings",
    description: "Capture, customize, and add shortcuts for every Graft command.",
    icon: "shortcut",
  ...
  },
  {
    ...
    description: "Give Codex, Claude, and other local agents scoped access to Graft tasks.",
    icon: "plugin-1",
  ...
  },
  {
    ...
    description: "Review and clean up isolated workspaces created by Graft.",
    icon: "branch-simple",
