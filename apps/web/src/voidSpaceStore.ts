...
// Layer: Web UI state
// Why: "Void" is Graft's word for "not filed yet", and it is the one Space label a user
...
import { SPACE_NAME_MAX_LENGTH } from "@graft/contracts";
...
const STORAGE_KEY = "graft:void-space:v1";
