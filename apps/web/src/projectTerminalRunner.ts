...
import type { NativeApi, TerminalSessionSnapshot, ThreadId } from "@graft/contracts";
import { deriveTerminalCommandIdentity, type TerminalCliKind } from "@graft/shared/terminalThreads";
