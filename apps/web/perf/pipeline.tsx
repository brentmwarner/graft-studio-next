...
// Exposes: window.__graftPipelinePerf { runStream, runQuiet, scrollCycle, snapshot, resetMetrics }
//
// URL params:
...
createRoot(rootElement).render(
  <StrictMode>
    <Profiler id="graft-pipeline-perf" onRender={handleRender}>
      <PipelineHarness />
    </Profiler>
  </StrictMode>,
);
